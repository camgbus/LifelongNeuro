...
def divide_events_by_splits(events_df, site_splits, ood_site_id=None):
    '''Divide a df of events into three for training, id id testing and OOD testing, based on the 
    subject_id'''
    subject_division = divide_subjects(site_splits, ood_site_id=ood_site_id)
...
def divide_subjects(site_splits, ood_site_id=None):
