...
VARS["tabular"]['alcohol_initiation'] = [("youthreport1", [("youthreport1_cddr15", "age_first_drink"), 
                                        ("youthreport1_cddr16", "age_regular_drinking")])]
...
VARS["structural"]["sMRI"] = [("lh.aparc", [("frontalpole_grayvol", "l_frontalpole_grayvol"),
              ...
              ("aseg", [("right_amygdala_volume_mm3", "right_amygdala_volume_mm3"), 
...
VARS["functional"]["fMRI_parc116"] = [("sri24_parc116_gm_roi2roi_correlations", [("{}-{}".format(n1, n2), "{}-{}".format(n1, n2)) for (n1, n2) in
                     product(fMRI_parcels["parc116"], fMRI_parcels["parc116"])])]

VARS["functional"]["fMRI_parc215"] =  [("sri24_parc215_gm_roi2roi_correlations", [("{}-{}".format(n1, n2), "{}-{}".format(n1, n2)) for (n1, n2) in
                     product(fMRI_parcels["parc215"], fMRI_parcels["parc215"])])]
'''



''''
# This I need to do, all the parental control variables are missing
family = [("clinical", [("fh_drug", "fh_drug_use"),
                      ("fh_drug_density", "fh_drug_use_density")]),
          ("youthreport1", [("youthreport1_ydi9", "living_arrangements")])]
          #("youthreport4", [("youthreport1_ydi10", "parents_married")]),
          #("youthreport5", [("youthreport1_ydi14", "long_term_plans")])]


# These are not used
clinical = [("clinical", [("rsq_problem_solving", "problem_solving"),
                          ("rsq_emotion_expression", "emotion_expression"),
                          ("rsq_acceptance", "acceptance"),
                          ("rsq_positive_thinking", "positive_thinking"),
                          ("rsq_emotion_regulation", "emotion_regulation"),
                          ("rsq_cognitive_restructuring", "cognitive_restructuring"),
                          ("rsq_distraction", "distraction"),
                          ("rsq_total_primary", "primary_subtotal"),
                          ("rsq_total_secondary", "secondary_subtotal")])]
'''