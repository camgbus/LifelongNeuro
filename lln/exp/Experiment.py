...
class Experiment:
    ...
    '''
    def __init__(self, name=None, output_path=None, config=None, notes='', reload_exp=False, debugging=False):
    ...
    def finish(self, failed=False, notes=''):
        ...
        if failed:
            ...
            with open(os.path.join(self.path, 'traceback.txt'), 'w', encoding="utf-8") as f:
                f.write(tb)
        else:
        ...
        if not self.debugging:
            ...
            with open(os.path.join(self.path, "stdout.txt"), 'w', encoding="utf-8") as f:
